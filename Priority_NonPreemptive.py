...
class PriorityNonPreemptiveClass(QWidget):
    ...
    def add_btn_click(self):
        if self.arrival_time_input.text().isdigit() and self.burst_time_input.text().isdigit() and self.priority_input.text().isdigit() and self.count < int(
            ...
            self.sorted_list.insert(self.Process_name_input.text(), int(self.arrival_time_input.text()), int(self.priority_input.text()),
                                    int(self.burst_time_input.text()))
            print(self.sorted_list)
            self.count = self.count + 1
            self.sorted_list.nonPreemptivePriority_sort()
    ...
    def plot_btn_click(self):
        ...
        if self.count == int(self.Process_number_input.text()):
            ...
            self.sorted_list.priority_graph()
