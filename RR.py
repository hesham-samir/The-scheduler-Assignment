...
class RRClass(QWidget):
    ...
    def add_btn_click(self):
        if self.arrival_time_input.text().isdigit() and self.burst_time_input.text().isdigit() and self.count < int(self.Process_number_input.text()):
    ...
    def process_number_added_btn_click(self):
        if self.Process_number_input.text().isdigit() and int(self.Process_number_input.text()) > 0 and self.quantum_time_input.text().isdigit() and int(self.quantum_time_input.text()) > 0:
            self.show_main()
        else:
